...
class EndCarPhotoScreen extends StatefulWidget {
  const EndCarPhotoScreen({Key? key}) : super(key: key);

  @override
  State<EndCarPhotoScreen> createState() => _EndCarPhotoScreenState();
}

class _EndCarPhotoScreenState extends State<EndCarPhotoScreen> {
                    ...
                    : () {
                        if (frontImg.isEmpty ||
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => EndCarKmScreen(
                                    insideImg: insideImg,
                                    frontImg: frontImg,
                                    backImg: backImg,
                                    rightImg: rightImg,
