            ...
            children: [
              ElevatedButton(
                    ...
                    : () {
                        if (getFileList.isEmpty) {
                          Utils.showToastAlert(
                              context, "Araç Fotoğrafını çekiniz.");
                        } else {
                          Navigator.pop(
                            context,
                          );
                ...
                child:  Padding(
                  ...
                  child: Text(
                    AppLocalizations.of(context)!.crash_button_text,
              ...
              Text(
                AppLocalizations.of(context)!.crash_bottom_text,
                style: TextStyle(
                      ...
                      children: [
                        ...
                        Align(
                          ...
                          child: UploadImageWidget(
                              title: AppLocalizations.of(context)!.crash_photo_text,
